...
### Lightning Base Damage = 127-4501 (x5.08 base mult)
...
### Combined DPS = 326,926

**类别汇总**: Hit: +273711.8 | DOT: +53214.5
...
| 来源 | 类别 | 值 |
|------|------|-----|
| 闪电 +0.0% (占53.9%) | Enemy | +0.0 |
| 火焰 +0.0% (占28.8%) | Enemy | +0.0 |
...
| 3 | lightning_pen | BASE | +20.5% | % | 0.97%/% | 0 | 需要 +20% 穿透 → DPS +20.0% |
...
| 13 | flat_fire_attack | BASE | +125.0 |  | 0.16%/1 | 0 | 需要添加 125-250 基础伤害 → DPS +20.1% |
| 14 | flat_cold_attack | BASE | +125.0 |  | 0.16%/1 | 0 | 需要添加 125-250 基础伤害 → DPS +20.1% |
| 15 | flat_physical_attack | BASE | +131.5 |  | 0.15%/1 | 0 | 需要添加 132-263 基础伤害 → DPS +20.1% |
| 16 | lightning_damage_inc | INC | +210.5% | % | 0.10%/% | 188 | INC 188%→398%, 需要 +210 → DPS +20.0% |
| 17 | fire_damage_inc | INC | +371.5% | % | 0.05%/% | 188 | INC 188%→560%, 需要 +372 → DPS +20.0% |
...
| 7 | Crashing Wave | Notable | -7.7% | +0.0% | 输出 | 36% increased Damage if you've dealt a Critical Hit in the past 8 seconds |
...
| 12 | Throatseeker | Notable | -4.8% | +0.0% | 输出 | 60% increased Critical Damage Bonus; 20% reduced Critical Hit Chance |
| 13 | Struck Through | Notable | -4.8% | +0.0% | 输出 | Attacks have +1% to Critical Hit Chance |
| 14 | Heartstopping | Notable | -4.8% | -0.3% | 兼顾 | +10 to Intelligence; 15% increased Critical Hit Chance |
...
| 2 | Electric Amplification | Notable | +23.8% | +0.0% | 输出 |
| 3 | Primal Sundering | Notable | +21.6% | +0.0% | 输出 |
| 4 | Exposed to the Storm | Notable | +18.0% | +0.0% | 输出 |
| 5 | Storm Surge | Notable | +17.1% | +0.0% | 输出 |
| 6 | Cremation | Notable | +15.1% | +0.0% | 输出 |
| 7 | Surging Currents | Notable | +15.0% | +0.0% | 输出 |
| 8 | Breath of Lightning | Notable | +15.0% | +0.0% | 输出 |
| 9 | Flash Storm | Notable | +15.0% | +0.0% | 输出 |
| 10 | Overload | Notable | +15.0% | +0.0% | 输出 |
...
当前 **Quarterstaff Strike** TotalDPS = **273,712**，AverageHit = 0，Speed = 2.60/s，CritChance = 64.2%，CritMultiplier = 6.19x。
...
| 3 | lightning_pen | BASE | 0 | +20% | 需要 +20% 穿透 → DPS +20.0% |
...
2. **Electric Amplification**: DPS +23.8%
3. **Primal Sundering**: DPS +21.6%
4. **Exposed to the Storm**: DPS +18.0%
