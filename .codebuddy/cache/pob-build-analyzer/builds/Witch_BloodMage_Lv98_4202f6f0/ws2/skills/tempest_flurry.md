...
### Lightning Base Damage = 60-2126 (x2.40 base mult)
...
| Rigwald's Ferocity | Skill | +30.0% MORE |
...
**类别汇总**: Skill: +67.0 | Sim: +26.0 | Tree: +26.0 | Item: +16.0
...
**类别汇总**: Skill: +2900.0 | Tree: +178.0

| 来源 | 类别 | 值 |
|------|------|-----|
| 技能#SupportRigwaldsFerocityPlayer | Skill | +2,900 |
| Crashing Wave | Tree | +36.0 |
| Deadly Force | Tree | +30.0 |
| Damage on Critical | Tree | +20.0 |
| Damage on Critical | Tree | +20.0 |
...
### Combined DPS = 134,643

**类别汇总**: Hit: +119853.6 | DOT: +14789.3
...
| 5 | fire_pen | BASE | +37.5% | % | 0.54%/% | 0 | 需要 +38% 穿透 → DPS +20.1% |
...
| 8 | attack_damage_inc | INC | +94.5% | % | 0.21%/% | 188 | INC 188%→282%, 需要 +94 → DPS +20.1% |
| 9 | melee_damage_inc | INC | +94.5% | % | 0.21%/% | 188 | INC 188%→282%, 需要 +94 → DPS +20.1% |
...
| 12 | flat_physical_attack | BASE | +117.5 |  | 0.17%/1 | 0 | 需要添加 118-235 基础伤害 → DPS +20.1% |
| 13 | flat_lightning_attack | BASE | +119.0 |  | 0.17%/1 | 0 | 需要添加 119-238 基础伤害 → DPS +20.0% |
| 14 | flat_fire_attack | BASE | +124.0 |  | 0.16%/1 | 0 | 需要添加 124-248 基础伤害 → DPS +20.0% |
| 15 | flat_cold_attack | BASE | +125.0 |  | 0.16%/1 | 0 | 需要添加 125-250 基础伤害 → DPS +20.2% |
| 16 | lightning_damage_inc | INC | +197.5% | % | 0.10%/% | 188 | INC 188%→386%, 需要 +198 → DPS +20.1% |
| 17 | fire_damage_inc | INC | +374.0% | % | 0.05%/% | 188 | INC 188%→562%, 需要 +374 → DPS +20.0% |
...
| 2 | Martial Artistry | Notable | -11.0% | +0.0% | 输出 | 25% increased Accuracy Rating with Quarterstaves; 25% increased Critical Damage Bonus with Quarterstaves; +25 to Dexterity |
| 3 | Eldritch Battery | Keystone | -10.9% | -5.0% | 兼顾 | Converts all Energy Shield to Mana; Doubles Mana Costs |
| 4 | Inspiring Ally | Notable | -10.2% | +0.0% | 输出 | Increases and Reductions to Companion Damage also apply to you |
| 5 | Deadly Force | Notable | -9.9% | +0.0% | 输出 | 30% increased Damage if you've dealt a Critical Hit in the past 8 seconds; 12% increased Critical Hit Chance |
| 6 | Critical Exploit | Notable | -7.9% | +0.0% | 输出 | 25% increased Critical Hit Chance |
...
| 11 | All Natural | Notable | -5.5% | -4.2% | 兼顾 | +5% to all Elemental Resistances; 30% increased Elemental Damage |
| 12 | Throatseeker | Notable | -4.9% | +0.0% | 输出 | 60% increased Critical Damage Bonus; 20% reduced Critical Hit Chance |
| 13 | Struck Through | Notable | -4.9% | +0.0% | 输出 | Attacks have +1% to Critical Hit Chance |
| 14 | Heartstopping | Notable | -4.9% | -0.3% | 兼顾 | +10 to Intelligence; 15% increased Critical Hit Chance |
| 15 | For the Jugular | Notable | -4.5% | -0.3% | 兼顾 | 25% increased Critical Damage Bonus; +10 to Intelligence |
...
| 6 | Surging Currents | Notable | +16.0% | +0.0% | 输出 |
| 7 | Breath of Lightning | Notable | +16.0% | +0.0% | 输出 |
| 8 | Flash Storm | Notable | +16.0% | +0.0% | 输出 |
| 9 | Overload | Notable | +16.0% | +0.0% | 输出 |
...
- **DPS 贡献**: +4.1% | **EHP 贡献**: -0.0% | **状态**: ok | **槽位**: Jewel 61834
- **分配天赋**: the spring hare, blood of rage (DPS +4.1%, EHP -0.0%)

| Mod | 类型 | 值 | DPS% | EHP% |
|-----|------|-----|------|------|
| GrantedPassive | LIST | the spring hare | +4.1% | -0.0% |
...
当前 **Tempest Flurry** TotalDPS = **119,854**，AverageHit = 0，Speed = 4.61/s，CritChance = 64.2%，CritMultiplier = 6.19x。
...
| 5 | fire_pen | BASE | 0 | +38% | 需要 +38% 穿透 → DPS +20.1% |
