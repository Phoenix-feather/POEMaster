...
### Lightning Base Damage = 77-3649 (x4.84 base mult)
...
| 来源 | 类别 | 值 |
|------|------|-----|
| Elemental Armament II | Skill | +25.0% MORE |
...
### Combined DPS = 103,607

**类别汇总**: Hit: +102027.2 | DOT: +1579.6
...
|---|------|------|--------|------|----------|--------|------|
| 1 | crit_chance_base | BASE | +3.5% | % | 6.16%/% | 1 | baseCrit 1.0%→4.5%, 需要 +3.5% → DPS +21.5% |
| 2 | elemental_pen | BASE | +14.0% | % | 1.53%/% | 0 | 需要 +14% 穿透 → DPS +21.5% |
| 3 | lightning_pen | BASE | +15.5% | % | 1.37%/% | 0 | 需要 +16% 穿透 → DPS +21.2% |
| 4 | attack_speed_inc | INC | +54.5% | % | 0.37%/% | 164 | INC 164%→218%, 需要 +54 → DPS +20.3% |
...
| 7 | flat_lightning_attack | BASE | +92.5 |  | 0.21%/1 | 0 | 需要添加 92-185 基础伤害 → DPS +19.9% |
| 8 | flat_fire_attack | BASE | +96.5 |  | 0.21%/1 | 0 | 需要添加 96-193 基础伤害 → DPS +19.8% |
| 9 | flat_cold_attack | BASE | +96.5 |  | 0.21%/1 | 0 | 需要添加 96-193 基础伤害 → DPS +19.8% |
| 10 | elemental_damage_inc | INC | +102.0% | % | 0.20%/% | 82 | INC 82%→184%, 需要 +102 → DPS +20.0% |
| 11 | flat_physical_attack | BASE | +111.5 |  | 0.18%/1 | 0 | 需要添加 112-223 基础伤害 → DPS +20.1% |
| 12 | lightning_damage_inc | INC | +119.0% | % | 0.17%/% | 82 | INC 82%→201%, 需要 +119 → DPS +20.0% |
| 13 | physical_damage_inc | INC | +132.5% | % | 0.15%/% | 82 | INC 82%→214%, 需要 +132 → DPS +20.0% |
| 14 | crit_chance_inc | INC | +487.0% | % | 0.04%/% | 31 | INC 31%→518%, 需要 +487 → DPS +20.0% |
...
|---|------|------|-------------|-------------|------|------|
| 1 | Inspiring Ally | Notable | -16.5% | +0.0% | 输出 | Increases and Reductions to Companion Damage also apply to you |
| 2 | Eldritch Battery | Keystone | -14.1% | -5.0% | 兼顾 | Converts all Energy Shield to Mana; Doubles Mana Costs |
...
| 7 | Material Solidification | Notable | -3.9% | +0.0% | 输出 | Gain 8% of Damage as Extra Physical Damage; 15% increased effect of Fully Broken Armour |
...
| 13 | Falcon Dive | Notable | -2.6% | +0.0% | 输出 | 1% increased Attack Speed per 250 Accuracy Rating |
...
| 4 | Surging Currents | Notable | +20.3% | +0.0% | 输出 |
| 5 | Breath of Lightning | Notable | +20.3% | +0.0% | 输出 |
...
当前 **Quarterstaff Strike** TotalDPS = **102,027**，AverageHit = 0，Speed = 5.83/s，CritChance = 2.1%，CritMultiplier = 3.55x。
...
| # | 维度 | 类型 | 当前值 | 所需值 | 公式 |
|---|------|------|--------|--------|------|
| 1 | crit_chance_base | BASE | 1 | +4% | baseCrit 1.0%→4.5%, 需要 +3.5% → DPS +21.5% |
| 2 | elemental_pen | BASE | 0 | +14% | 需要 +14% 穿透 → DPS +21.5% |
| 3 | lightning_pen | BASE | 0 | +16% | 需要 +16% 穿透 → DPS +21.2% |
| 4 | attack_speed_inc | INC | 164 | +54% | INC 164%→218%, 需要 +54 → DPS +20.3% |
...
4. **Surging Currents**: DPS +20.3%
5. **Breath of Lightning**: DPS +20.3%
