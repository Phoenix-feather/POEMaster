...
| 5 | crit_chance_inc | INC | +73.5% | % | 0.27%/% | 66 | INC 66%→140%, 需要 +74 → DPS +20.1% |
...
| 8 | lightning_damage_inc | INC | +434.5% | % | 0.05%/% | 253 | INC 253%→688%, 需要 +434 → DPS +20.0% |
...
| 6 | True Strike | Notable | -5.5% | +0.0% | 输出 |
| 7 | Breaking Point | Notable | -4.7% | +0.0% | 输出 |
| 8 | Throatseeker | Notable | -4.5% | +0.0% | 输出 |
| 9 | Sudden Escalation | Notable | -4.4% | +0.0% | 输出 |
| 10 | For the Jugular | Notable | -3.7% | -0.4% | 兼顾 |
...
| 3 | Endless Blizzard | Notable | +16.1% | +0.0% | 输出 |
| 4 | Stormcharged | Notable | +15.6% | +0.0% | 输出 |
| 5 | Power of the Storm | Notable | +13.8% | +0.0% | 输出 |
| 6 | Calculated Hunter | Notable | +13.7% | +0.0% | 输出 |
| 7 | Temporal Mastery | Notable | +12.3% | +0.0% | 输出 |
| 8 | Arcane Intensity | Notable | +11.6% | +0.0% | 输出 |
| 9 | Jack of all Trades | Notable | +11.1% | +0.0% | 输出 |
| 10 | Sacrificial Blood | Notable | +11.1% | +0.0% | 输出 |
...
当前 **Frost Bomb** TotalDPS = **17,947**，AverageHit = 41,416，Speed = 0.43/s，CritChance = 27.2%，CritMultiplier = 4.05x。
...
| 5 | crit_chance_inc | INC | 66 | +74% | INC 66%→140%, 需要 +74 → DPS +20.1% |
...
3. **Endless Blizzard**: DPS +16.1%
4. **Stormcharged**: DPS +15.6%
