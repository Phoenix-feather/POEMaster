...
| 4 | spell_damage_inc | INC | +88.5% | % | 0.23%/% | 343 | INC 343%→432%, 需要 +88 → DPS +20.1% |
| 5 | elemental_damage_inc | INC | +88.5% | % | 0.23%/% | 343 | INC 343%→432%, 需要 +88 → DPS +20.1% |
| 6 | cold_damage_inc | INC | +106.5% | % | 0.19%/% | 343 | INC 343%→450%, 需要 +106 → DPS +20.1% |
...
|---|------|------|-------------|-------------|------|------|
| 1 | Thin Ice | Notable | -11.3% | +0.0% | 输出 | 20% increased Freeze Buildup; 50% increased Damage with Hits against Frozen Enemies |
| 2 | Crashing Wave | Notable | -8.2% | +0.0% | 输出 | 36% increased Damage if you've dealt a Critical Hit in the past 8 seconds |
...
| 5 | All Natural | Notable | -6.8% | +0.0% | 输出 | +5% to all Elemental Resistances; 30% increased Elemental Damage |
| 6 | True Strike | Notable | -6.7% | +0.0% | 输出 | +10 to Dexterity; 20% increased Critical Hit Chance |
| 7 | Potent Incantation | Notable | -6.3% | +0.0% | 输出 | 30% increased Spell Damage; 5% reduced Cast Speed |
| 8 | Sudden Escalation | Notable | -6.2% | +0.0% | 输出 | 16% increased Critical Hit Chance for Spells; 8% increased Cast Speed if you've dealt a Critical Hit Recently |
...
| 13 | Acceleration | Notable | -1.1% | +0.0% | 输出 | 3% increased Movement Speed; 10% increased Skill Speed |
| 14 | Flow Like Water | Notable | -0.9% | -0.2% | 兼顾 | 8% increased Attack and Cast Speed; +5 to Dexterity and Intelligence |
...
| # | 天赋 | 类型 | DPS% | EHP% | 分类 |
|---|------|------|------|------|------|
| 1 | Climate Change | Notable | +18.6% | +0.0% | 输出 |
| 2 | Stormbreaker | Notable | +18.1% | +0.0% | 输出 |
| 3 | Harness the Elements | Notable | +18.1% | +0.0% | 输出 |
| 4 | Endless Blizzard | Notable | +16.8% | +0.0% | 输出 |
| 5 | Calculated Hunter | Notable | +16.2% | +0.0% | 输出 |
| 6 | Stormcharged | Notable | +14.6% | +0.0% | 输出 |
| 7 | Biting Frost | Notable | +13.0% | +0.0% | 输出 |
| 8 | Sitting Duck | Notable | +11.8% | +0.0% | 输出 |
| 9 | Power of the Storm | Notable | +11.3% | +0.0% | 输出 |
| 10 | Vulgar Methods | Notable | +10.1% | -2.1% | 兼顾 |
...
- **DPS 贡献**: +3.4% | **EHP 贡献**: +2.4% | **状态**: ok | **槽位**: Jewel 61834
...
|---|------|------------|----------|-----|------|
| 1 | Trinity | +50.7% | +60.2% (辅助+9.5%) (条件: Total Resonance Count=150) | +0.0% | 100 |
...
| Total Resonance Count=300 | +62.9% | +74.4% | +11.4% | 137%→159% |
...
| 3 | Charge Infusion | +16.4% | +16.4% ⚠️模拟 | +0.0% | 30 |
...
- **Elemental Conflux** (Lv21): 分别注入 70% MORE 到火/冰/电取平均。伤害构成：火 0.0% / 冰 83.7% / 电 16.4%
  三次模拟 DPS：火 26056 / 冰 41314 / 电 29036
...
| 2 | Archmage（大法师） | 100 | +41.7% | +0.0% | 需精魄 100（缺 100）; Mana 转附加闪电伤害 |
...
| # | 精魄辅助 | 精魄 | DPS% | 条件 | 来源 |
|---|----------|------|------|------|------|
| 1 | Mysticism II | 30 | +9.1% | 需精魄 30（缺 30） ⚠️估算 | 动态扫描 |
| 2 | Mysticism I | 15 | +6.8% | 需精魄 15（缺 15） ⚠️估算 | 动态扫描 |
...
当前 **Comet** TotalDPS = **156,390**，AverageHit = 216,772，Speed = 0.72/s，CritChance = 34.5%，CritMultiplier = 4.65x。
...
| 4 | spell_damage_inc | INC | 343 | +88% | INC 343%→432%, 需要 +88 → DPS +20.1% |
| 5 | elemental_damage_inc | INC | 343 | +88% | INC 343%→432%, 需要 +88 → DPS +20.1% |
...
1. **Climate Change**: DPS +18.6%
2. **Stormbreaker**: DPS +18.1%
3. **Harness the Elements**: DPS +18.1%
4. **Endless Blizzard**: DPS +16.8%
5. **Calculated Hunter**: DPS +16.2%
