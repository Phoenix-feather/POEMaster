...
1. **crit_chance_base** (BASE): 每 1% 提升 7.17% DPS，需要 +3% 达到 +20% DPS
2. **crit_multi_base** (BASE): 每 1% 提升 0.63% DPS，需要 +30% 达到 +20% DPS
...
### CritChance BASE = 50.5% (base 9.0% + added 0%)
...
**公式**: `基础 1229-22618 × effMult 1.6770  (持续 4.40s, 几率 18.6%)`

**类别汇总**: Sim: +2900.0 | Support: +1900.0 | Tree: +141.0
...
### Combined DPS = 737,956

**类别汇总**: Hit: +711933.6 | DOT: +26022.2
...
### Cold-Infused 弹体数量 BASE = 19

**类别汇总**: SkillEffect: +19.0

| 来源 | 类别 | 值 |
|------|------|-----|
| Cold-Infused效果 | SkillEffect | +19.0 |
...
|---|------|------|--------|------|----------|--------|------|
| 1 | crit_chance_base | BASE | +3.0% | % | 7.17%/% | 0 | baseCrit 0.0%→3.0%, 需要 +3.0% → DPS +21.5% |
| 2 | crit_multi_base | BASE | +30.5% | % | 0.63%/% | 100 | CritBase 100→130, 需要 +30 → DPS +19.4% |
...
| 7 | crit_chance_inc | INC | +109.0% | % | 0.18%/% | 251 | INC 251%→360%, 需要 +109 → DPS +20.0% |
| 8 | crit_multi_inc | INC | +111.5% | % | 0.18%/% | 260 | INC 260%→372%, 需要 +112 → DPS +20.1% |
| 9 | lightning_damage_inc | INC | +151.5% | % | 0.13%/% | 368 | INC 368%→520%, 需要 +152 → DPS +20.0% |
| 10 | fire_damage_inc | INC | +305.0% | % | 0.07%/% | 368 | INC 368%→673%, 需要 +305 → DPS +20.0% |
...
| 3 | Throatseeker | Notable | -7.7% | +0.0% | 输出 | 60% increased Critical Damage Bonus; 20% reduced Critical Hit Chance |
...
| 6 | All Natural | Notable | -6.4% | -4.2% | 兼顾 | +5% to all Elemental Resistances; 30% increased Elemental Damage |
| 7 | Careful Assassin | Notable | -6.1% | +0.0% | 输出 | 20% reduced Critical Damage Bonus; 50% increased Critical Hit Chance |
| 8 | Sudden Escalation | Notable | -6.0% | +0.0% | 输出 | 16% increased Critical Hit Chance for Spells; 8% increased Cast Speed if you've dealt a Critical Hit Recently |
| 9 | The Spring Hare | Notable | -5.7% | +0.0% | 输出 | 20% chance for Damage of Enemies Hitting you to be Unlucky; 20% chance for Damage with Hits to be Lucky |
| 10 | I am the Blizzard... | Notable | -5.0% | +0.0% | 输出 | Gain 10% of Damage as Extra Cold Damage; On Freezing Enemies create Chilled Ground |
| 11 | I am the Thunder... | Notable | -4.9% | +0.0% | 输出 | Gain 10% of Damage as Extra Lightning Damage; 25% chance on Shocking Enemies to created Shocked Ground |
...
| 13 | Critical Exploit | Notable | -4.6% | +0.0% | 输出 | 25% increased Critical Hit Chance |
| 14 | Evocational Practitioner | Notable | -4.6% | +0.0% | 输出 | 25% increased Critical Hit Chance if you've Triggered a Skill Recently; Meta Skills gain 25% increased Energy if you've dealt a Critical Hit Recently |
| 15 | Potent Incantation | Notable | -4.6% | +0.0% | 输出 | 30% increased Spell Damage; 5% reduced Cast Speed |
| 16 | For the Jugular | Notable | -4.5% | -0.4% | 兼顾 | 25% increased Critical Damage Bonus; +10 to Intelligence |
| 17 | True Strike | Notable | -3.7% | +0.0% | 输出 | +10 to Dexterity; 20% increased Critical Hit Chance |
| 18 | Flow Like Water | Notable | -3.1% | -0.2% | 兼顾 | 8% increased Attack and Cast Speed; +5 to Dexterity and Intelligence |
| 19 | Moment of Truth | Notable | -2.8% | +0.0% | 输出 | 25% increased Critical Damage Bonus if you've dealt a Non-Critical Hit Recently; 15% increased Critical Hit Chance |
...
| # | 天赋 | 类型 | DPS% | EHP% | 分类 |
|---|------|------|------|------|------|
| 1 | Stormbreaker | Notable | +17.1% | +0.0% | 输出 |
| 2 | Harness the Elements | Notable | +17.1% | +0.0% | 输出 |
| 3 | Stand and Deliver | Notable | +12.9% | +0.0% | 输出 |
| 4 | Stormcharged | Notable | +11.5% | +0.0% | 输出 |
| 5 | Cooked | Notable | +10.8% | -4.6% | 兼顾 |
| 6 | Power of the Storm | Notable | +10.7% | +0.0% | 输出 |
| 7 | The Frenzied Bear | Notable | +10.6% | +0.4% | 兼顾 |
| 8 | Master of Hexes | Notable | +10.0% | +0.0% | 输出 |
| 9 | Arcane Intensity | Notable | +9.6% | +0.0% | 输出 |
| 10 | Heavy Ammunition | Notable | +8.5% | +0.0% | 输出 |
...
|---|------|------------|----------|-----|------|
| 1 | Trinity | +57.5% | +70.9% (辅助+13.3%) (条件: Total Resonance Count=150) | +0.0% | 100 |
...
| Total Resonance Count=300 | +70.3% | +85.9% | +15.6% | 134%→156% |
...
| 2 | Charge Infusion | +27.8% | +27.8% ⚠️模拟 | +0.0% | 30 |
...
- **Elemental Conflux** (Lv21): 分别注入 70% MORE 到火/冰/电取平均。伤害构成：火 30.7% / 冰 7.5% / 电 61.8%
  三次模拟 DPS：火 131162 / 冰 113643 / 电 154661
...
- **构筑已有 modifier**：施法速度 INC 156%（来自 POB skillModList），总 MORE ×1.56。INC 叠加为加法（新增边际递减），MORE 叠加为乘法
...
当前 **Spark** TotalDPS = **711,934**，AverageHit = 194,669，Speed = 3.66/s，CritChance = 50.5%，CritMultiplier = 4.60x。
...
| # | 维度 | 类型 | 当前值 | 所需值 | 公式 |
|---|------|------|--------|--------|------|
| 1 | crit_chance_base | BASE | 0 | +3% | baseCrit 0.0%→3.0%, 需要 +3.0% → DPS +21.5% |
| 2 | crit_multi_base | BASE | 100 | +30% | CritBase 100→130, 需要 +30 → DPS +19.4% |
...
1. **Stormbreaker**: DPS +17.1%
2. **Harness the Elements**: DPS +17.1%
3. **Stand and Deliver**: DPS +12.9%
4. **Stormcharged**: DPS +11.5%
5. **Cooked**: DPS +10.8%，EHP -4.6%
