...
**类别汇总**: Sim: +183% | Skill: +56% | Other: +40%
...
**类别汇总**: Item: +64.0 | Skill: +48.0 | Sim: +25.0 | Tree: +19.0

| 来源 | 类别 | 值 |
|------|------|-----|
| Charge Infusion | Skill | +26.0 |
...
**类别汇总**: Skill: +27% | Sim: +26%

| 来源 | 类别 | 值 |
|------|------|-----|
| Charge Infusion | Skill | +27.0% MORE |
...
**无法达到目标**: 混沌抗性, 冰霜抗性, 护甲固定值, 物理减伤, 闪电抗性, 护甲增加, 闪避增加, 火焰抗性, 生命固定值
