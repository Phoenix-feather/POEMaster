...
**公式**: `基础 4414-8184 × effMult 1.6770  (持续 4.40s, 几率 10.4%)`
...
| 来源 | 类别 | 值 |
|------|------|-----|
| 火焰 x0.6450 (占58.3%) | Enemy | +0.6 |
| 闪电 x0.6450 (占25.0%) | Enemy | +0.6 |
| 冰霜 x0.6450 (占14.2%) | Enemy | +0.6 |
| 物理 x1.2900 (占2.5%) | Enemy | +1.3 |
