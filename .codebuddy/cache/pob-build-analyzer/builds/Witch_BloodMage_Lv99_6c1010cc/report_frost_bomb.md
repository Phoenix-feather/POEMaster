...
**公式**: `基础 8800-13171 × 效果 1.1100 × 0.2层 × effMult 1.1200  (持续 3.56s, 几率 30.8%)`
...
| 6 | spell_damage_inc | INC | +158.0% | % | 0.13%/% | 691 | INC 691%→849%, 需要 +158 → DPS +20.0% |
| 7 | elemental_damage_inc | INC | +158.0% | % | 0.13%/% | 691 | INC 691%→849%, 需要 +158 → DPS +20.0% |
| 8 | cold_damage_inc | INC | +240.0% | % | 0.08%/% | 691 | INC 691%→931%, 需要 +240 → DPS +20.1% |
...
|---|------|------|-------------|-------------|------|------|
| 1 | Stormbreaker | Notable | -10.1% | +0.0% | 输出 | 20% increased Damage for each type of Elemental Ailment on Enemy |
| 2 | Sunder the Flesh | Notable | -10.1% | +0.0% | 输出 | Base Critical Hit Chance for Spells is 15% |
...
- **Elemental Conflux** (Lv25): 分别注入 74% MORE 到火/冰/电取平均。伤害构成：火 31.4% / 冰 66.1% / 电 2.5%
  三次模拟 DPS：火 24326 / 冰 29390 / 电 20100
...
当前 **Frost Bomb** TotalDPS = **80,489**，AverageHit = 185,745，Speed = 0.43/s，CritChance = 85.3%，CritMultiplier = 4.62x。
