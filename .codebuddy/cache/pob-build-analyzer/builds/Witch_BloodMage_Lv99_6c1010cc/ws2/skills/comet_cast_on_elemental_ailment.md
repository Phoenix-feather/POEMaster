...
| 5 | spell_damage_inc | INC | +130.5% | % | 0.15%/% | 553 | INC 553%→684%, 需要 +130 → DPS +20.0% |
| 6 | cold_damage_inc | INC | +130.5% | % | 0.15%/% | 553 | INC 553%→684%, 需要 +130 → DPS +20.0% |
| 7 | elemental_damage_inc | INC | +130.5% | % | 0.15%/% | 553 | INC 553%→684%, 需要 +130 → DPS +20.0% |
| 8 | cast_speed_inc | INC | +281.5% | % | 0.07%/% | 130 | INC 130%→412%, 需要 +282 → DPS +20.0% |

**无影响维度**: physical_damage_inc, fire_damage_inc, lightning_damage_inc, chaos_damage_inc, lightning_pen, fire_pen, cold_pen, elemental_pen, chaos_pen, projectile_count, aoe_inc, duration_inc
...
| 2 | Throatseeker | Notable | -9.6% | +0.0% | 输出 | 60% increased Critical Damage Bonus; 20% reduced Critical Hit Chance |
| 3 | Stormcharged | Notable | -9.0% | +0.0% | 输出 | 40% increased Elemental Damage if you've dealt a Critical Hit Recently; 15% increased Critical Hit Chance |
| 4 | Sunder the Flesh | Notable | -8.7% | +0.0% | 输出 | Base Critical Hit Chance for Spells is 15% |
...
| 7 | Careful Assassin | Notable | -6.4% | +0.0% | 输出 | 20% reduced Critical Damage Bonus; 50% increased Critical Hit Chance |
| 8 | Dynamism | Notable | -6.1% | +0.0% | 输出 | 40% increased Damage if you've Triggered a Skill Recently; Meta Skills gain 15% increased Energy |
| 9 | Invocated Efficiency | Notable | -6.1% | +0.0% | 输出 | 10% increased Mana Cost Efficiency; Triggered Spells deal 40% increased Spell Damage |
| 10 | For the Jugular | Notable | -5.4% | -0.3% | 兼顾 | 25% increased Critical Damage Bonus; +10 to Intelligence |
| 11 | Evocational Practitioner | Notable | -5.0% | +0.0% | 输出 | 25% increased Critical Hit Chance if you've Triggered a Skill Recently; Meta Skills gain 25% increased Energy if you've dealt a Critical Hit Recently |
| 12 | All Natural | Notable | -4.6% | +0.0% | 输出 | +5% to all Elemental Resistances; 30% increased Elemental Damage |
| 13 | Sudden Escalation | Notable | -4.3% | +0.0% | 输出 | 16% increased Critical Hit Chance for Spells; 8% increased Cast Speed if you've dealt a Critical Hit Recently |
| 14 | True Strike | Notable | -4.0% | +0.0% | 输出 | +10 to Dexterity; 20% increased Critical Hit Chance |
| 15 | Potent Incantation | Notable | -4.0% | +0.0% | 输出 | 30% increased Spell Damage; 5% reduced Cast Speed |
...
| 17 | Acceleration | Notable | -1.4% | +0.0% | 输出 | 3% increased Movement Speed; 10% increased Skill Speed |
...
| 19 | Practiced Signs | Notable | -0.8% | +0.0% | 输出 | 6% increased Cast Speed |
...
| 2 | Endless Blizzard | Notable | +14.9% | +0.0% | 输出 |
| 3 | Cooked | Notable | +12.9% | -5.4% | 兼顾 |
| 4 | Barbaric Strength | Notable | +9.7% | +0.3% | 兼顾 |
| 5 | Calculated Hunter | Notable | +9.3% | +0.0% | 输出 |
| 6 | Biting Frost | Notable | +8.9% | +0.0% | 输出 |
| 7 | Power of the Storm | Notable | +7.7% | +0.0% | 输出 |
| 8 | Sitting Duck | Notable | +7.0% | +0.0% | 输出 |
| 9 | Shredding Force | Notable | +6.4% | +0.0% | 输出 |
| 10 | The Noble Wolf | Notable | +6.3% | +0.0% | 输出 |
...
- **DPS 贡献**: +12.2% | **EHP 贡献**: -0.0% | **状态**: ok | **槽位**: Jewel 21984
- **分配天赋**: invocated limit, harness the elements (DPS +12.2%, EHP -0.0%)

| Mod | 类型 | 值 | DPS% | EHP% |
|-----|------|-----|------|------|
| GrantedPassive | LIST | invocated limit | -0.0% | -0.0% |
| GrantedPassive | LIST | harness the elements | +12.2% | -0.0% |
...
- **DPS 贡献**: +3.8% | **EHP 贡献**: +3.0% | **状态**: ok | **槽位**: Jewel 61834
...
|---|------|------------|----------|-----|------|
| 1 | Trinity | +59.4% | +60.9% (辅助+1.5%) (条件: Total Resonance Count=150) | +0.0% | 100 |
...
| Total Resonance Count=300 | +73.6% | +75.3% | +1.7% | 108%→130% |

### 辅助贡献

- **Dialla's Desire**: +1 level, +10% quality
- **Lightning Mastery**: +1 level
- 总辅助贡献: **+1.5%** DPS（Total Resonance Count=150时）
- 端点差异: Total Resonance Count=0时+0.0%，Total Resonance Count=300时+1.7%
...
| 3 | Charge Infusion | +20.6% | +20.6% ⚠️模拟 | +0.0% | 30 |
...
- **Elemental Conflux** (Lv25): 分别注入 74% MORE 到火/冰/电取平均。伤害构成：火 0.0% / 冰 100.0% / 电 0.0%
  三次模拟 DPS：火 41628 / 冰 72432 / 电 41628
...
| # | 精魄辅助 | 精魄 | DPS% | 条件 | 来源 |
|---|----------|------|------|------|------|
| 1 | Mysticism II | 30 | +6.1% | 需精魄 30（缺 30） ⚠️估算 | 动态扫描 |
| 2 | Mysticism I | 15 | +4.6% | 需精魄 15（缺 15） ⚠️估算 | 动态扫描 |
...
当前 **Comet** TotalDPS = **177,363**，AverageHit = 254,477，Speed = 0.70/s，CritChance = 61.7%，CritMultiplier = 4.04x。
...
| 5 | spell_damage_inc | INC | 553 | +130% | INC 553%→684%, 需要 +130 → DPS +20.0% |
...
2. **Endless Blizzard**: DPS +14.9%
3. **Cooked**: DPS +12.9%，EHP -5.4%
4. **Barbaric Strength**: DPS +9.7%，EHP +0.3%
5. **Calculated Hunter**: DPS +9.3%
...
**最佳**: Megalomaniac (DPS +12.2%, EHP -0.0%)
