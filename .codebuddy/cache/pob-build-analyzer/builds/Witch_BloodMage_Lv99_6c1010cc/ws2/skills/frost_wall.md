...
| 2 | Sunder the Flesh | Notable | -18.8% | +0.0% | 输出 | Base Critical Hit Chance for Spells is 15% |
| 3 | Throatseeker | Notable | -10.4% | +0.0% | 输出 | 60% increased Critical Damage Bonus; 20% reduced Critical Hit Chance |
| 4 | Stormcharged | Notable | -10.3% | +0.0% | 输出 | 40% increased Elemental Damage if you've dealt a Critical Hit Recently; 15% increased Critical Hit Chance |
...
当前 **Frost Wall** TotalDPS = **17,844**，AverageHit = 74,349，Speed = 0.24/s，CritChance = 79.2%，CritMultiplier = 4.04x。
