...
3. **spell_damage_inc** (INC): 每 1% 提升 0.15% DPS，需要 +130% 达到 +20% DPS
...
| 3 | spell_damage_inc | INC | +130.5% | % | 0.15%/% | 553 | INC 553%→684%, 需要 +130 → DPS +20.0% |
| 4 | cold_damage_inc | INC | +130.5% | % | 0.15%/% | 553 | INC 553%→684%, 需要 +130 → DPS +20.0% |
| 5 | elemental_damage_inc | INC | +130.5% | % | 0.15%/% | 553 | INC 553%→684%, 需要 +130 → DPS +20.0% |

**无影响维度**: physical_damage_inc, fire_damage_inc, lightning_damage_inc, chaos_damage_inc, crit_chance_inc, crit_chance_base, cast_speed_inc, lightning_pen, fire_pen, cold_pen, elemental_pen, chaos_pen, projectile_count, aoe_inc, duration_inc
...
| 3 | Sunder the Flesh | Notable | -9.4% | +0.0% | 输出 | Base Critical Hit Chance for Spells is 15% |
| 4 | Stormcharged | Notable | -9.2% | +0.0% | 输出 | 40% increased Elemental Damage if you've dealt a Critical Hit Recently; 15% increased Critical Hit Chance |
...
| 11 | Evocational Practitioner | Notable | -5.5% | +0.0% | 输出 | 25% increased Critical Hit Chance if you've Triggered a Skill Recently; Meta Skills gain 25% increased Energy if you've dealt a Critical Hit Recently |
...
| 14 | Sudden Escalation | Notable | -4.4% | +0.0% | 输出 | 16% increased Critical Hit Chance for Spells; 8% increased Cast Speed if you've dealt a Critical Hit Recently |
| 15 | Potent Incantation | Notable | -4.1% | +0.0% | 输出 | 30% increased Spell Damage; 5% reduced Cast Speed |
...
| 17 | The Spring Hare | Notable | -1.3% | +0.0% | 输出 | 20% chance for Damage of Enemies Hitting you to be Unlucky; 20% chance for Damage with Hits to be Lucky |
| 18 | Acceleration | Notable | -1.1% | +0.0% | 输出 | 3% increased Movement Speed; 10% increased Skill Speed |
...
| 4 | Barbaric Strength | Notable | +10.5% | +0.3% | 兼顾 |
| 5 | Calculated Hunter | Notable | +10.3% | +0.0% | 输出 |
| 6 | Biting Frost | Notable | +8.9% | +0.0% | 输出 |
| 7 | Power of the Storm | Notable | +7.7% | +0.0% | 输出 |
| 8 | Sitting Duck | Notable | +7.6% | +0.0% | 输出 |
| 9 | Shredding Force | Notable | +6.9% | +0.0% | 输出 |
| 10 | The Noble Wolf | Notable | +6.7% | +0.0% | 输出 |
...
|---|------|------------|----------|-----|------|
| 1 | Trinity | +58.7% | +60.0% (辅助+1.2%) (条件: Total Resonance Count=150) | +0.0% | 100 |
...
| Total Resonance Count=300 | +73.1% | +74.4% | +1.4% | 135%→157% |
...
| 3 | Charge Infusion | +21.6% | +21.6% ⚠️模拟 | +0.0% | 30 |
...
- **Elemental Conflux** (Lv25): 分别注入 74% MORE 到火/冰/电取平均。伤害构成：火 0.0% / 冰 100.0% / 电 0.0%
  三次模拟 DPS：火 50522 / 冰 87906 / 电 50522
...
当前 **Comet** TotalDPS = **209,903**，AverageHit = 291,577，Speed = 0.72/s，CritChance = 79.2%，CritMultiplier = 4.04x。
...
| 3 | spell_damage_inc | INC | 553 | +130% | INC 553%→684%, 需要 +130 → DPS +20.0% |
| 4 | cold_damage_inc | INC | 553 | +130% | INC 553%→684%, 需要 +130 → DPS +20.0% |
| 5 | elemental_damage_inc | INC | 553 | +130% | INC 553%→684%, 需要 +130 → DPS +20.0% |
...
4. **Barbaric Strength**: DPS +10.5%，EHP +0.3%
5. **Calculated Hunter**: DPS +10.3%
