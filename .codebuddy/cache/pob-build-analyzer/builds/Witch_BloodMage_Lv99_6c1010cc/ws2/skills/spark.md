...
### 元素伤害 MORE (Lightning,Cold) = +476.6%
...
| 6 | spell_damage_inc | INC | +113.0% | % | 0.18%/% | 467 | INC 467%→580%, 需要 +113 → DPS +20.0% |
| 7 | projectile_damage_inc | INC | +113.0% | % | 0.18%/% | 467 | INC 467%→580%, 需要 +113 → DPS +20.0% |
| 8 | elemental_damage_inc | INC | +113.0% | % | 0.18%/% | 467 | INC 467%→580%, 需要 +113 → DPS +20.0% |
| 9 | lightning_damage_inc | INC | +147.0% | % | 0.14%/% | 467 | INC 467%→614%, 需要 +147 → DPS +20.0% |
| 10 | cold_damage_inc | INC | +488.0% | % | 0.04%/% | 453 | INC 453%→941%, 需要 +488 → DPS +20.0% |
...
| 2 | Sunder the Flesh | Notable | -26.1% | +0.0% | 输出 | Base Critical Hit Chance for Spells is 15% |
| 3 | Stormcharged | Notable | -9.9% | +0.0% | 输出 | 40% increased Elemental Damage if you've dealt a Critical Hit Recently; 15% increased Critical Hit Chance |
...
| 8 | Sudden Escalation | Notable | -6.6% | +0.0% | 输出 | 16% increased Critical Hit Chance for Spells; 8% increased Cast Speed if you've dealt a Critical Hit Recently |
| 9 | Careful Assassin | Notable | -6.4% | +0.0% | 输出 | 20% reduced Critical Damage Bonus; 50% increased Critical Hit Chance |
| 10 | The Spring Hare | Notable | -5.7% | +0.0% | 输出 | 20% chance for Damage of Enemies Hitting you to be Unlucky; 20% chance for Damage with Hits to be Lucky |
| 11 | For the Jugular | Notable | -5.4% | -0.3% | 兼顾 | 25% increased Critical Damage Bonus; +10 to Intelligence |
| 12 | All Natural | Notable | -5.3% | +0.0% | 输出 | +5% to all Elemental Resistances; 30% increased Elemental Damage |
| 13 | Evocational Practitioner | Notable | -5.0% | +0.0% | 输出 | 25% increased Critical Hit Chance if you've Triggered a Skill Recently; Meta Skills gain 25% increased Energy if you've dealt a Critical Hit Recently |
...
| 16 | Potent Incantation | Notable | -3.3% | +0.0% | 输出 | 30% increased Spell Damage; 5% reduced Cast Speed |
...
| 18 | Practiced Signs | Notable | -2.6% | +0.0% | 输出 | 6% increased Cast Speed |
...
| # | 天赋 | 类型 | DPS% | EHP% | 分类 |
|---|------|------|------|------|------|
| 1 | Stand and Deliver | Notable | +13.4% | +0.0% | 输出 |
| 2 | Cooked | Notable | +12.9% | -5.4% | 兼顾 |
| 3 | Barbaric Strength | Notable | +9.7% | +0.3% | 兼顾 |
| 4 | Power of the Storm | Notable | +8.9% | +0.0% | 输出 |
| 5 | Calculated Hunter | Notable | +7.7% | +0.0% | 输出 |
| 6 | Pure Power | Notable | +7.4% | +0.0% | 输出 |
| 7 | Jack of all Trades | Notable | +7.1% | +0.0% | 输出 |
| 8 | Heavy Ammunition | Notable | +7.1% | +0.0% | 输出 |
| 9 | Fulmination | Notable | +7.1% | +0.0% | 输出 |
| 10 | Sitting Duck | Notable | +7.0% | +0.0% | 输出 |
...
|---|------|------------|----------|-----|------|
| 1 | Trinity | +67.1% | +72.4% (辅助+5.2%) (条件: Total Resonance Count=150) | +0.0% | 100 |
...
| Total Resonance Count=300 | +82.1% | +87.8% | +5.7% | 108%→130% |
...
- **Elemental Conflux** (Lv25): 分别注入 74% MORE 到火/冰/电取平均。伤害构成：火 0.0% / 冰 22.7% / 电 77.3%
  三次模拟 DPS：火 51049 / 冰 59618 / 电 80260
...
当前 **Spark** TotalDPS = **236,131**，AverageHit = 71,866，Speed = 3.29/s，CritChance = 61.7%，CritMultiplier = 4.04x。
...
1. **Stand and Deliver**: DPS +13.4%
2. **Cooked**: DPS +12.9%，EHP -5.4%
3. **Barbaric Strength**: DPS +9.7%，EHP +0.3%
4. **Power of the Storm**: DPS +8.9%
5. **Calculated Hunter**: DPS +7.7%
