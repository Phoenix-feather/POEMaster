...
| 5 | Limitless Pursuit | Notable | +10.8% | +0.0% | 输出 |
| 6 | Calculated Hunter | Notable | +10.1% | +0.0% | 输出 |
| 7 | Barbaric Strength | Notable | +9.7% | +0.3% | 兼顾 |
...
| Total Resonance Count=300 | +69.9% | +69.9% | — | 108%→130% |
...
- **Elemental Conflux** (Lv25): 分别注入 74% MORE 到火/冰/电取平均。伤害构成：火 0.0% / 冰 100.0% / 电 0.0%
  三次模拟 DPS：火 6527 / 冰 11355 / 电 6527
...
当前 **Frost Bomb** TotalDPS = **26,772**，AverageHit = 61,781，Speed = 0.43/s，CritChance = 61.7%，CritMultiplier = 4.04x。
