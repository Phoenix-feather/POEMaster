...
### 元素伤害 MORE (Lightning,Cold,Fire) = +476.6%
...
**公式**: `基础 1265-23957 × 效果 1.1100 × effMult 1.1200  (持续 3.56s, 几率 26.0%)`
...
### Combined DPS = 528,360

**类别汇总**: Hit: +510231.5 | DOT: +18128.6
...
| 3 | lightning_pen | BASE | +22.5% | % | 0.87%/% | 0 | 需要 +22% 穿透 → DPS +19.7% |
| 4 | crit_multi_base | BASE | +30.0% | % | 0.67%/% | 100 | CritBase 100→130, 需要 +30 → DPS +20.1% |
| 5 | fire_pen | BASE | +37.5% | % | 0.54%/% | 0 | 需要 +38% 穿透 → DPS +20.4% |
| 6 | cast_speed_inc | INC | +45.5% | % | 0.45%/% | 126 | INC 126%→172%, 需要 +46 → DPS +20.4% |
| 7 | crit_multi_inc | INC | +90.5% | % | 0.22%/% | 202 | INC 202%→292%, 需要 +90 → DPS +20.1% |
| 8 | crit_chance_inc | INC | +105.0% | % | 0.19%/% | 249 | INC 249%→354%, 需要 +105 → DPS +20.1% |
| 9 | spell_damage_inc | INC | +159.5% | % | 0.13%/% | 705 | INC 705%→864%, 需要 +160 → DPS +20.1% |
| 10 | projectile_damage_inc | INC | +159.5% | % | 0.13%/% | 705 | INC 705%→864%, 需要 +160 → DPS +20.1% |
| 11 | elemental_damage_inc | INC | +159.5% | % | 0.13%/% | 705 | INC 705%→864%, 需要 +160 → DPS +20.1% |
| 12 | lightning_damage_inc | INC | +311.0% | % | 0.06%/% | 705 | INC 705%→1016%, 需要 +311 → DPS +20.0% |

**无影响维度**: physical_damage_inc, fire_damage_inc, cold_damage_inc, chaos_damage_inc, cold_pen, chaos_pen, projectile_count, aoe_inc, duration_inc
...
|---|------|------|-------------|-------------|------|------|
| 1 | Sunder the Flesh | Notable | -26.7% | +0.0% | 输出 | Base Critical Hit Chance for Spells is 15% |
| 2 | Throatseeker | Notable | -10.2% | +0.0% | 输出 | 60% increased Critical Damage Bonus; 20% reduced Critical Hit Chance |
| 3 | Stormbreaker | Notable | -10.1% | +0.0% | 输出 | 20% increased Damage for each type of Elemental Ailment on Enemy |
| 4 | Stormcharged | Notable | -7.8% | +0.0% | 输出 | 40% increased Elemental Damage if you've dealt a Critical Hit Recently; 15% increased Critical Hit Chance |
| 5 | Gore Spike | Notable | -7.7% | +0.0% | 输出 | 1% increased Critical Damage Bonus per 50 current Life |
...
| 7 | Thin Ice | Notable | -6.3% | +0.0% | 输出 | 20% increased Freeze Buildup; 50% increased Damage with Hits against Frozen Enemies |
...
| 10 | Sacrificial Blood | Notable | -5.0% | +0.0% | 输出 | 15% increased Life Cost of Skills; 40% increased Spell Damage with Spells that cost Life |
| 11 | Dynamism | Notable | -5.0% | +0.0% | 输出 | 40% increased Damage if you've Triggered a Skill Recently; Meta Skills gain 15% increased Energy |
| 12 | Deadly Force | Notable | -5.0% | +0.0% | 输出 | 25% increased Damage if you've dealt a Critical Hit in the past 8 seconds; 10% increased Critical Hit Chance |
...
| 16 | All Natural | Notable | -3.8% | +0.0% | 输出 | +5% to all Elemental Resistances; 30% increased Elemental Damage |
...
Invocated Echoes, The Spring Hare, Blood Transfusion, Echoing Thunder, Energise, Heavy Frost, Echoing Frost, Invocated Efficiency, Overflowing Power, Echoing Flames, Sanguine Tides, Vitality Siphon, Marked Agility, Acceleration, Infusion of Power, Sanguimancy
...
|---|------|------------|----------|-----|------|
| 1 | Trinity | +67.3% | +72.7% (辅助+5.3%) (条件: Total Resonance Count=150) | +0.0% | 100 |
...
| Total Resonance Count=300 | +82.3% | +88.2% | +5.8% | 104%→126% |

### 辅助贡献

- **Dialla's Desire**: +1 level, +10% quality
- **Lightning Mastery**: +1 level
- 总辅助贡献: **+5.3%** DPS（Total Resonance Count=150时）
- 端点差异: Total Resonance Count=0时+0.0%，Total Resonance Count=300时+5.8%
...
- **Elemental Conflux** (Lv25): 分别注入 74% MORE 到火/冰/电取平均。伤害构成：火 31.2% / 冰 17.0% / 电 51.8%
  三次模拟 DPS：火 232684 / 冰 212804 / 电 261574
...
- **构筑已有 modifier**：施法速度 INC 126%（来自 POB skillModList），总 MORE ×1.56。INC 叠加为加法（新增边际递减），MORE 叠加为乘法
...
当前 **Spark** TotalDPS = **510,231**，AverageHit = 158,036，Speed = 3.23/s，CritChance = 66.5%，CritMultiplier = 4.02x。
...
| 3 | lightning_pen | BASE | 0 | +22% | 需要 +22% 穿透 → DPS +19.7% |
...
**⚠️ 16 个无效天赋**: Invocated Echoes, The Spring Hare, Blood Transfusion, Echoing Thunder, Energise, Heavy Frost, Echoing Frost, Invocated Efficiency 等 16 个
