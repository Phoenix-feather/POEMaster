...
3. **fire_pen** (BASE): 每 1% 提升 1.34% DPS，需要 +14% 达到 +20% DPS
...
**公式**: `基础 4192-6332 × 效果 1.1100 × effMult 1.1200  (持续 3.56s, 几率 13.0%)`
...
| 3 | fire_pen | BASE | +14.5% | % | 1.34%/% | 0 | 需要 +14% 穿透 → DPS +19.4% |
...
| 8 | spell_damage_inc | INC | +162.5% | % | 0.12%/% | 709 | INC 709%→872%, 需要 +162 → DPS +20.0% |
| 9 | elemental_damage_inc | INC | +162.5% | % | 0.12%/% | 709 | INC 709%→872%, 需要 +162 → DPS +20.0% |
| 10 | fire_damage_inc | INC | +202.0% | % | 0.10%/% | 709 | INC 709%→911%, 需要 +202 → DPS +20.0% |

**无影响维度**: physical_damage_inc, cold_damage_inc, lightning_damage_inc, chaos_damage_inc, lightning_pen, cold_pen, chaos_pen, projectile_count, aoe_inc, duration_inc
...
| 9 | Cooked | Notable | +13.3% | -5.4% | 兼顾 |
| 10 | Barbaric Strength | Notable | +10.2% | +0.3% | 兼顾 |
...
|---|------|------------|----------|-----|------|
| 1 | Trinity | +67.4% | +72.7% (辅助+5.3%) (条件: Total Resonance Count=150) | +0.0% | 100 |
...
| Total Resonance Count=300 | +82.4% | +88.2% | +5.8% | 104%→126% |
...
- **Elemental Conflux** (Lv25): 分别注入 74% MORE 到火/冰/电取平均。伤害构成：火 80.3% / 冰 17.2% / 电 2.5%
  三次模拟 DPS：火 56966 / 冰 40287 / 电 36374
...
当前 **Living Bomb** TotalDPS = **96,433**，AverageHit = 25,602，Speed = 3.77/s，CritChance = 66.5%，CritMultiplier = 4.02x。
...
| 3 | fire_pen | BASE | 0 | +14% | 需要 +14% 穿透 → DPS +19.4% |
