...
**公式**: `基础 8679-12998 × 效果 1.1100 × 0.3层 × effMult 1.1200  (持续 3.56s, 几率 30.4%)`
...
| 6 | spell_damage_inc | INC | +158.0% | % | 0.13%/% | 691 | INC 691%→849%, 需要 +158 → DPS +20.1% |
| 7 | elemental_damage_inc | INC | +158.0% | % | 0.13%/% | 691 | INC 691%→849%, 需要 +158 → DPS +20.1% |
| 8 | cold_damage_inc | INC | +239.5% | % | 0.08%/% | 691 | INC 691%→930%, 需要 +240 → DPS +20.0% |
| 9 | fire_damage_inc | INC | +497.5% | % | 0.04%/% | 681 | INC 681%→1178%, 需要 +498 → DPS +20.0% |

**无影响维度**: physical_damage_inc, lightning_damage_inc, chaos_damage_inc, crit_chance_inc, crit_chance_base, speed_inc, lightning_pen, chaos_pen, projectile_count, aoe_inc, duration_inc
...
|---|------|------|-------------|-------------|------|------|
| 1 | Sunder the Flesh | Notable | -20.1% | +0.0% | 输出 | Base Critical Hit Chance for Spells is 15% |
...
| 4 | Stormcharged | Notable | -8.2% | +0.0% | 输出 | 40% increased Elemental Damage if you've dealt a Critical Hit Recently; 15% increased Critical Hit Chance |
...
| 9 | Deadly Force | Notable | -5.3% | +0.0% | 输出 | 25% increased Damage if you've dealt a Critical Hit in the past 8 seconds; 10% increased Critical Hit Chance |
...
| 12 | Sacrificial Blood | Notable | -5.1% | +0.0% | 输出 | 15% increased Life Cost of Skills; 40% increased Spell Damage with Spells that cost Life |
| 13 | Dynamism | Notable | -5.1% | +0.0% | 输出 | 40% increased Damage if you've Triggered a Skill Recently; Meta Skills gain 15% increased Energy |
| 14 | True Strike | Notable | -4.3% | +0.0% | 输出 | +10 to Dexterity; 20% increased Critical Hit Chance |
| 15 | Potent Incantation | Notable | -3.8% | +0.0% | 输出 | 30% increased Spell Damage; 5% reduced Cast Speed |
| 16 | All Natural | Notable | -3.8% | -5.3% | 兼顾 | +5% to all Elemental Resistances; 30% increased Elemental Damage |
| 17 | Sudden Escalation | Notable | -3.5% | +0.0% | 输出 | 16% increased Critical Hit Chance for Spells; 8% increased Cast Speed if you've dealt a Critical Hit Recently |
...
Invocated Echoes, The Spring Hare, Blood Transfusion, Practiced Signs, Echoing Thunder, Energise, Heavy Frost, Echoing Frost, Invocated Efficiency, Echoing Flames, Sanguine Tides, Vitality Siphon, Marked Agility, Acceleration, Infusion of Power, Sanguimancy
...
| 9 | Cremation | Notable | +13.6% | +0.0% | 输出 |
| 10 | Temporal Mastery | Notable | +13.3% | +0.0% | 输出 |
...
| Total Resonance Count=300 | +70.0% | +70.0% | — | 131%→153% |
...
| 3 | Charge Infusion | +19.4% | +19.4% ⚠️模拟 | +0.0% | 30 |
...
- **Elemental Conflux** (Lv25): 分别注入 74% MORE 到火/冰/电取平均。伤害构成：火 31.4% / 冰 66.1% / 电 2.5%
  三次模拟 DPS：火 13298 / 冰 16068 / 电 10989
...
当前 **Frost Wall** TotalDPS = **44,004**，AverageHit = 183,349，Speed = 0.24/s，CritChance = 85.3%，CritMultiplier = 4.62x。
...
**⚠️ 16 个无效天赋**: Invocated Echoes, The Spring Hare, Blood Transfusion, Practiced Signs, Echoing Thunder, Energise, Heavy Frost, Echoing Frost 等 16 个
