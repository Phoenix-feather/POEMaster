...
**公式**: `基础 8975-13442 × 效果 1.1100 × 0.2层 × effMult 1.1200  (持续 3.56s, 几率 23.1%)`
...
|---|------|------|-------------|-------------|------|------|
| 1 | Sunder the Flesh | Notable | -17.8% | +0.0% | 输出 | Base Critical Hit Chance for Spells is 15% |
...
| 6 | Thin Ice | Notable | -6.3% | +0.0% | 输出 | 20% increased Freeze Buildup; 50% increased Damage with Hits against Frozen Enemies |
...
| 9 | Sacrificial Blood | Notable | -5.1% | +0.0% | 输出 | 15% increased Life Cost of Skills; 40% increased Spell Damage with Spells that cost Life |
| 10 | Dynamism | Notable | -5.1% | +0.0% | 输出 | 40% increased Damage if you've Triggered a Skill Recently; Meta Skills gain 15% increased Energy |
| 11 | Deadly Force | Notable | -5.0% | +0.0% | 输出 | 25% increased Damage if you've dealt a Critical Hit in the past 8 seconds; 10% increased Critical Hit Chance |
...
| 14 | True Strike | Notable | -3.8% | +0.0% | 输出 | +10 to Dexterity; 20% increased Critical Hit Chance |
...
| 17 | Sudden Escalation | Notable | -3.1% | +0.0% | 输出 | 16% increased Critical Hit Chance for Spells; 8% increased Cast Speed if you've dealt a Critical Hit Recently |
...
- **Elemental Conflux** (Lv25): 分别注入 74% MORE 到火/冰/电取平均。伤害构成：火 31.4% / 冰 66.1% / 电 2.5%
  三次模拟 DPS：火 17274 / 冰 20873 / 电 14274
...
当前 **Frost Wall** TotalDPS = **33,475**，AverageHit = 139,478，Speed = 0.24/s，CritChance = 66.5%，CritMultiplier = 4.02x。
