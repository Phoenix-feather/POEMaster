...
**公式**: `基础 33618-50443 × 效果 1.1100 × effMult 1.1200  (持续 3.56s, 几率 76.1%)`
...
### Combined DPS = 522,577

**类别汇总**: Hit: +362277.3 | DOT: +43216.9
...
| 8 | spell_damage_inc | INC | +163.5% | % | 0.12%/% | 719 | INC 719%→882%, 需要 +164 → DPS +20.0% |
| 9 | elemental_damage_inc | INC | +163.5% | % | 0.12%/% | 719 | INC 719%→882%, 需要 +164 → DPS +20.0% |
| 10 | cold_damage_inc | INC | +248.0% | % | 0.08%/% | 719 | INC 719%→967%, 需要 +248 → DPS +20.0% |
| 11 | cast_speed_inc | INC | +269.0% | % | 0.07%/% | 126 | INC 126%→395%, 需要 +269 → DPS +20.0% |

**无影响维度**: physical_damage_inc, fire_damage_inc, lightning_damage_inc, chaos_damage_inc, lightning_pen, chaos_pen, projectile_count, aoe_inc, duration_inc
...
|---|------|------|-------------|-------------|------|------|
| 1 | Throatseeker | Notable | -10.2% | +0.0% | 输出 | 60% increased Critical Damage Bonus; 20% reduced Critical Hit Chance |
| 2 | Stormbreaker | Notable | -9.8% | +0.0% | 输出 | 20% increased Damage for each type of Elemental Ailment on Enemy |
| 3 | Sunder the Flesh | Notable | -8.9% | +0.0% | 输出 | Base Critical Hit Chance for Spells is 15% |
| 4 | Gore Spike | Notable | -7.7% | +0.0% | 输出 | 1% increased Critical Damage Bonus per 50 current Life |
| 5 | Stormcharged | Notable | -7.6% | +0.0% | 输出 | 40% increased Elemental Damage if you've dealt a Critical Hit Recently; 15% increased Critical Hit Chance |
| 6 | Thin Ice | Notable | -6.1% | +0.0% | 输出 | 20% increased Freeze Buildup; 50% increased Damage with Hits against Frozen Enemies |
| 7 | Careful Assassin | Notable | -5.8% | +0.0% | 输出 | 20% reduced Critical Damage Bonus; 50% increased Critical Hit Chance |
| 8 | For the Jugular | Notable | -5.5% | -0.3% | 兼顾 | 25% increased Critical Damage Bonus; +10 to Intelligence |
| 9 | Deadly Force | Notable | -4.9% | +0.0% | 输出 | 25% increased Damage if you've dealt a Critical Hit in the past 8 seconds; 10% increased Critical Hit Chance |
| 10 | Sacrificial Blood | Notable | -4.9% | +0.0% | 输出 | 15% increased Life Cost of Skills; 40% increased Spell Damage with Spells that cost Life |
| 11 | Dynamism | Notable | -4.9% | +0.0% | 输出 | 40% increased Damage if you've Triggered a Skill Recently; Meta Skills gain 15% increased Energy |
| 12 | Evocational Practitioner | Notable | -4.8% | +0.0% | 输出 | 25% increased Critical Hit Chance if you've Triggered a Skill Recently; Meta Skills gain 25% increased Energy if you've dealt a Critical Hit Recently |
| 13 | Critical Overload | Notable | -4.7% | +0.0% | 输出 | 15% increased Critical Hit Chance for Spells; 15% increased Spell Damage if you've dealt a Critical Hit Recently |
| 14 | Sudden Escalation | Notable | -4.1% | +0.0% | 输出 | 16% increased Critical Hit Chance for Spells; 8% increased Cast Speed if you've dealt a Critical Hit Recently |
...
| 17 | Potent Incantation | Notable | -3.0% | +0.0% | 输出 | 30% increased Spell Damage; 5% reduced Cast Speed |
...
|---|------|------------|----------|-----|------|
| 1 | Trinity | +59.5% | +61.0% (辅助+1.6%) (条件: Total Resonance Count=150) | +0.0% | 100 |
...
| Total Resonance Count=300 | +73.8% | +75.5% | +1.7% | 104%→126% |

### 辅助贡献

- **Dialla's Desire**: +1 level, +10% quality
- **Lightning Mastery**: +1 level
- 总辅助贡献: **+1.6%** DPS（Total Resonance Count=150时）
...
| 3 | Charge Infusion | +21.2% | +21.2% ⚠️模拟 | +0.0% | 30 |
...
- **Elemental Conflux** (Lv25): 分别注入 74% MORE 到火/冰/电取平均。伤害构成：火 31.4% / 冰 66.1% / 电 2.5%
  三次模拟 DPS：火 179801 / 冰 217206 / 电 148560
...
当前 **Comet** TotalDPS = **362,277**，AverageHit = 522,577，Speed = 0.69/s，CritChance = 66.5%，CritMultiplier = 4.02x。
